...
public class PhaseTwo 
{
	...
	FileInputFormat.addInputPath(job, new Path("/user/balasusp/q4/program3/phase1"));
	FileOutputFormat.setOutputPath(job,new Path("/user/balasusp/q4/program3/phase2"));
